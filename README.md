...
| 임예나 | - 🚀 찜하기 기능 백엔드 구현 <br>- 🧪 후기 및 게시판 기능 풀스택 개발 및 UI 작업 <br>- 💾 파일 첨부 및 수정 기능 <br>- ⭐ 후기 작성 시 신뢰도 점수 반영 <br>- 🌐 거래 완료 기능 백엔드 구현 <br>- 📊 후기 통계 출력 기능 <br>- 🖼️ 채팅창 프로필 사진 불러오기 <br>- 🔄 판매 기능 내 QR 코드 삽입 |
